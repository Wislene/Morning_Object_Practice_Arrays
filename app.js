...
// const jupiter = solarSystem.find(planet => planet.name === "Jupiter");
// console.log(jupiter);
...
// console.log(neptuneMoons[1]);

// 3. Add a new moon called "Endor" to Venus' moons array.

// solarSystem.push({ name: "Venus", ringSystem: false, moons: ["Endor"] });
...
// const mercury = solarSystem.find(planet => planet.name === "Mercury");
...
// const jupiterSatellites = Number(system.jupiter.satellites);
// const totalSatellites = jupiterSatellites + system.saturn.satellites + system.uranus.satellites + system.neptune.satellites;
...
// typeof system.mercury.radiusp === 'string' && (system.mercury.radiusp = system.mercury.radiuse);
